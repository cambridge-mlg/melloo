...
In turn, this file has been borrowed from: https://raw.githubusercontent.com/cambridge-mlg/LITE/main/src/mahalanonbis.py
"""

class MahalanobisPredictor(nn.Module):
    def __init__(self):
        super(MahalanobisPredictor, self).__init__()
        return
    ...
    def predict(self, target_features):
        return self._predict(target_features, self.prototypes, self.precisions)

    def _predict(self, target_features, class_means, class_precision_matrices):
